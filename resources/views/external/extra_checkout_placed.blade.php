                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-8">
                        <div class="order-placed-dt">
                            ...
                            <h2>Payment Placed</h2>
                            <p>Thank you for your order!</p>
                            <p class="mt-2">You will receive a notification once your order is ready</p>
...
{{--                                    <li><p><i class="uil uil-card-atm"></i>Payment Method :<span>{{ $orderTransaction->paymentMethod ? $orderTransaction->paymentMethod->name : '' }}</span></p></li>--}}
                                    <li><p><i class="uil uil-card-atm"></i>Total :<span><strong style="font-size: 16px">{{ $orderTransaction->transaction_total > 0 ? '$' . $orderTransaction->transaction_total : 'Needs Confirmation' }}</strong></span></p></li>
                                </ul>
