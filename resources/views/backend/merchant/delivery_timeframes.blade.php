                ...
                <div class="category-model-content modal-content">
                    ...
                    <div class="add-address-form">
                        <div class="checout-delivery_timeframe-step">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="{{ route('backend.merchant.delivery_timeframes.store') }}" method="POST">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between w-100">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <ul class="action-btns mt-0">
                                                                    <li><a href="{{ route('backend.merchant.delivery_timeframes.delete', $deliveryTimeframeItem->id) }}" class="action-btn"><i class="uil uil-trash-alt"></i></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
