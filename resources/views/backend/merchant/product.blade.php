                ...
                <div class="category-model-content modal-content">
                    ...
                    <div class="add-address-form">
                        <div class="checout-address-step">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="{{ route('backend.merchant.product.mutator.group.store') }}" method="POST">
                ...
                <div class="category-model-content modal-content">
                    ...
                    <div class="add-address-form">
                        <div class="checout-address-step">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="{{ route('backend.merchant.product.mutator.group.item.store') }}" method="POST">
                                        <input type="hidden" name="merchant_id" value="{{ $merchant->id }}">
                                        <input type="hidden" name="product_id" value="{{ $product->id }}">
                ...
                <div class="category-model-content modal-content">
                    ...
                    <div class="add-address-form">
                        <div class="checout-address-step">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="{{ route('backend.merchant.product.mutator.group.delete') }}" method="POST">
                                        <input type="hidden" name="merchant_id" value="{{ $merchant->id }}">
                                        <input type="hidden" name="product_id" value="{{ $product->id }}">
                ...
                <div class="category-model-content modal-content">
                    ...
                    <div class="add-address-form">
                        <div class="checout-address-step">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="{{ route('backend.merchant.product.mutator.group.item.delete') }}" method="POST">
                                        <input type="hidden" name="merchant_id" value="{{ $merchant->id }}">
                                        <input type="hidden" name="product_id" value="{{ $product->id }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="pdpt-bg">
                                            ...
                                            <form method="POST" action="{{ route('backend.merchant.product.store', ['merchant_id' => $merchant->id]) }}" enctype="multipart/form-data">
