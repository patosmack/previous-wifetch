...
@section('content')
    ...
    <div class="wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="title129">
                            <h2 class="m-0 p-0">How would you rate your experience using WiFetch?</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="life-theme">
            <div class="container">
                <form action="{{ route('service.rate.store') }}" method="post" class="widget">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 offset-md-3">
                        <div class="default-title left-text">
                            <h1 class="text-center">How did we do it?</h1>
                        </div>
                    ...
                    <div class="col-md-6 offset-md-3 mt-3">
                        <div class="default-title left-text mt-3">
                            <h1 class="text-center">Your comments are welcomed</h1>
                        </div>
                        <textarea name="message" id="review_message" class="form-control" cols="15" rows="5" placeholder="Please feel free to leave any comments here"></textarea>
                        <button type="submit" class="add-cart-btn hover-btn d-block mt-4" style="margin: 0 auto"><i class="uil uil-shopping-cart-alt"></i>Submit my review</button>
                    </div>
