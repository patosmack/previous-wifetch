                ...
                <div class="category-model-content modal-content">
                    ...
                    <div class="add-address-form">
                        <div class="checout-available_hour-step">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="{{ route('account.merchant.available_hours.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="main-title-tab">
                                        <h4><i class="uil uil-location-point"></i>Business Available Hours</h4>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12">
                                    <div class="pdpt-bg">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between w-100">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <ul class="action-btns mt-0">
                                                                    <li><a href="{{ route('account.merchant.available_hours.delete', $availableHourItem->id) }}" class="action-btn"><i class="uil uil-trash-alt"></i></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
